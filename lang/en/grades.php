...
+$string['gradeitemhidegrader'] = 'Hide grader name';
+$string['gradeitemhidegrader_help'] ='Hide the grader name from any user enrolled in the course that does not have the ability to grade.';
